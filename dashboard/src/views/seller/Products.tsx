                        ...
                        <tbody>
                            {[1, 2, 3, 4, 5].map((_, i) => (
                                <tr key={uuidv4()} className="border-b border-gray-300">
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>Culture Embroidered Varsity Jacket</td>
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>Hoodies</td>
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>Brand one</td>
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>$150</td>
